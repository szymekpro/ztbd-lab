"""Run all PostgreSQL benchmarks (INSERT/READ/UPDATE/DELETE) in one go.
...
Examples:
  ...
  python postgres/run_all_psql_benchmarks.py --both-index-modes

  # Run all benchmarks for a single scale
  python postgres/run_all_psql_benchmarks.py --scales 1000000 --both-index-modes
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Runs all PostgreSQL benchmark suites sequentially: "
    ...
    scripts = [
        ...
        postgres_dir / "benchmark_psql_read_scenarios.py",
        postgres_dir / "benchmark_psql_update_scenarios.py",
        postgres_dir / "benchmark_psql_delete_scenarios.py",
    ]
