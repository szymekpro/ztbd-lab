...
```py postgres/benchmark_psql_insert_scenarios.py --scales 500000,1000000,10000000 --runs-per-scenario 3 --prepare-mode seed-script --seed-value 1 --both-index-modes --concurrent-chunk-size 500```
